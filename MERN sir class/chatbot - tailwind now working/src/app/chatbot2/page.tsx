  ...
  return (
    <aside className="max-w-[320px] w-full flex flex-col gap-3 p-3">
      <div className="flex justify-between items-center text-white/80">
        <h2 className="text-16 font-semibold">Future Inc AI</h2>
        <div className="flex items-center gap-2">
          <p className="text-12 font-semibold">Live preview</p>
          <Switch />
          <X className="w-4 h-4" />
        </div>
      </div>
      ...
      <Select>
        <SelectTrigger className="w-full bg-white/4 border border-white/12 text-white/70 placeholder:text-white">
          <SelectValue
        ...
        <SelectContent>
          <SelectItem value="fixed-width">Elily Cue - DE Agent</SelectItem>
          <SelectItem value="delimited">Jack Harper - BA Agent </SelectItem>
          <SelectItem value="json">Fab Senchuri - BA Agent </SelectItem>
        </SelectContent>
      </Select>
        ...
        {messages.map((msg, idx) => (
          ...
          >
            ...
            >
              ...
              <div
                className={`flex items-center gap-2 text-10 text-white/70 ${
                  msg.isUser ? "flex-row-reverse" : "flex-row"
                }`}
              >
      ...
      >
        <input
          ...
          className="w-full bg-white/10 px-3 py-2 rounded-12 placeholder:text-white placeholder:text-12 text-white"
